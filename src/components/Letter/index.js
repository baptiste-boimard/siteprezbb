  ...
  return (
    ...
    <Modal show={isOpenLetter}>
        ...
        <Modal.Body>
          <p>Madame, Monsieur, </p>
          <br /><br />
          Tout fraîchement reconverti depuis l'année dernière dans le développement web, je suis à la recherche d'un employeur afin de poursuivre ma formation au sein d'une 3ème année de bachelor pour devenir chef de projets digitaux qui se déroule en alternance. Cet enseignement est dispensé par la Normandie Web School de Rouen et vient compléter ma formation initiale de développeur fullstack javascript dispensée par l'école O'Clock en 2022.
          <br /><br />
          ...
          <br /><br />
          De nature enjouée, joviale et avec un fort esprit d'équipe , je sais m'intégrer rapidement au sein d'une nouvelle équipe ou d'un nouvel environnement de travail. 
